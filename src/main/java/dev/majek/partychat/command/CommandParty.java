...
import dev.majek.partychat.gui.GuiNoParty;
...
import dev.majek.partychat.gui.GuiInParty;
...
public class CommandParty implements CommandExecutor, TabCompleter {
    ...
    public @Nullable List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command,
        ...
        arguments.add("rename"); arguments.add("summon"); arguments.add("shareitem"); arguments.add("version");
