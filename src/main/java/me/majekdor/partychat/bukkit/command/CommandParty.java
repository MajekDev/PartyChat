...
import me.majekdor.partychat.bukkit.command.party.*;
import me.majekdor.partychat.bukkit.data.Party;
import me.majekdor.partychat.bukkit.data.Restrictions;
import me.majekdor.partychat.bukkit.gui.GuiInParty;
import me.majekdor.partychat.bukkit.gui.GuiNoParty;
import me.majekdor.partychat.bukkit.util.Bar;
import me.majekdor.partychat.bukkit.util.Chat;
import me.majekdor.partychat.bukkit.util.TabCompleterBase;
            ...
            switch (args[0]) {
                ...
                case "join":
                    ...
                    for (Party party : Party.parties.values())
                        if (party.isPublic)
                            publicParties.add(Party.getRawName(party));
                    return TabCompleterBase.filterStartingWith(args[1], publicParties);
                default:
